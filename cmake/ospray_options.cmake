    ...
    ELSE()
      ...
      IF (NOT APPLE)
        IF(CMAKE_BUILD_TYPE MATCHES DEBUG)
          ...
          get_filename_component(TBB_LIBNAME_DEBUG ${TBB_LIBRARY_DEBUG} NAME)
          get_filename_component(TBB_MALLOC_LIBNAME_DEBUG ${TBB_LIBRARY_MALLOC_DEBUG} NAME)
          OSPRAY_INSTALL_NAMELINK(tbb ${TBB_LIBNAME_DEBUG})
          OSPRAY_INSTALL_NAMELINK(tbbmalloc ${TBB_MALLOC_LIBNAME_DEBUG})
        ELSE()
